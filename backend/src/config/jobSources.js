...
module.exports = {
  ...
  leverCompanies: parseList(process.env.JOB_LEVER_BOARDS, ['palantir', 'spotify', 'binance']),
  ...
  weworkRemotelyFeeds: parseList(process.env.JOB_WWR_FEEDS, [
  ...
  adzunaQueries: parseList(process.env.ADZUNA_QUERIES, [
